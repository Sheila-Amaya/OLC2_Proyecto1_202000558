...
function peg$parse(input, options) {
  ...
  var peg$e35 = peg$classExpectation(["\"", "\\", "n", "r", "t"], false, false);
  ...
  var peg$f27 = function(callee, args) { return args };
  var peg$f28 = function(callee, params) {
  ...
  var peg$f33 = function() { return crearNodo('numero', { tipo: 'int', valor: parseInt(text(), 10) }); };
  var peg$f34 = function() { return crearNodo('numero', { tipo: 'float', valor: parseFloat(text(), 10) });  };
  var peg$f35 = function() { return crearNodo('bool', { tipo: 'bool', valor: true }); };
  var peg$f36 = function() { return crearNodo('bool', { tipo: 'bool', valor: false }); };
  var peg$f37 = function(chars) { 
      return crearNodo('string', { tipo: 'string', valor: chars.join("") }); 
    };
  var peg$f38 = function(ch) { 
      switch(ch) {
          case '"': return '"';
          case '\\': return '\\';
          case 'n': return '\n';
  ...
  var peg$f39 = function(char) { return crearNodo('char', { tipo: 'char', valor: char }); };
